const APILINK = 'https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=a9f89fece1309f8a1532b5cdd5fc5f07&page=1';
...
function returnMovies(url){
    ...
    .then(function(data) {
        ...
        data.results.array.forEach(element => {
            ...
            div_row.appendColumn(div_column);
